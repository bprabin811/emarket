  ...
  <div class="small-container">
   <div class="row row-2">
    ...
    <div class="row">
        ...
        <?php
            $sq="SELECT product.id,product.pname,product.pdetail,product.price,product.availity,product.picture,product.category,seller.store,seller.saddress FROM product,seller where product.sphone=seller.sphone ORDER BY price LIMIT 8,8";
