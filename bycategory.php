...
<body>
  ...
  <div class="small-container">
   <div class="row row-2">
      ...
      <nav>
           <ul>
                <li><a href="product.php"><u>View by Default</u></a></li>
...
<!--  -------------------------------------->
      ...
      <div class="categoryname">
                ...
                <h2>&nbsp;&nbsp;Choose Category:</a> 
                <a href="leafygreen.php">&nbsp;&nbsp;<u>Leafy Green</u></a>
                <a href="cruciferous.php">&nbsp;&nbsp;<u>Cruciferous</u></a>
                <a href="root.php">&nbsp;&nbsp;<u>Root</u></a>
                <a href="allium.php">&nbsp;&nbsp;<u>Allium</u></a>
                <a href="marrow.php">&nbsp;&nbsp;<u>Marrow</u></a>
        
      </div>
<!-- --------------------------------------------------- -->
    
     <br>
   <h2>&nbsp;&nbsp;Default Category Products:</h2><br>
    <div class="row">
     
        <?php
            $sq="SELECT product.id,product.pname,product.pdetail,product.price,product.availity,product.picture,product.category,seller.store,seller.saddress FROM product,seller where product.sphone=seller.sphone AND product.category='Default' LIMIT 8";
