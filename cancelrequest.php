...
date_default_timezone_set('Asia/Katmandu');
    ...
    $sql="UPDATE `ordertable` SET id='$pid',`status`='Order Canceled',`dateandtime`='$myDate' WHERE id='$pid'";
    $result=mysqli_query($conn,$sql);
...
//        $url = "http://".$_SERVER["HTTP_HOST"].dirname($_SERVER["PHP_SELF"])."/resetpassword.php?code=$code";
        ...
        $mail->Subject = 'Sorry to inform that your order is cancelled due to some reasons.';
...
echo ("<script LANGUAGE='JavaScript'>
            window.alert('Order Request rejected.');
