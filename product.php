   ...
   <div class="row row-2">
    ...
    <div class="row">
        ...
        <?php
            ...
            $sq="SELECT product.id,product.pname,product.pdetail,product.price,product.availity,product.picture,product.category,seller.store,seller.saddress FROM product,seller where product.sphone=seller.sphone LIMIT 8";
...
<a href="productpage2.php"><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Next Page&raquo;</h2></a><br>
<!------------------------------------footer-------------------------------->
<div class="footer">
    <div class="container">
        <div class="row">
