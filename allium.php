...
<!-- --------------------------------------------------- -->
   ...
   <h2>&nbsp;&nbsp;Allium:</h2><br>
    <div class="row">
        ...
        <?php
            $sq="SELECT product.id,product.pname,product.pdetail,product.price,product.availity,product.picture,product.category,seller.store,seller.saddress FROM product,seller where product.sphone=seller.sphone AND product.category='allium' LIMIT 8";
