  ...
  <div class="small-container">
   <div class="row row-2">
    ...
    <div class="row">
        ...
        <?php
            $sq="SELECT product.id,product.pname,product.pdetail,product.price,product.availity,product.picture,product.category,seller.store,seller.saddress FROM product,seller where product.sphone=seller.sphone ORDER BY pname LIMIT 8,8";
...
<a href="productbyname.php"><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&laquoPrevious Page</h2></a><br>
